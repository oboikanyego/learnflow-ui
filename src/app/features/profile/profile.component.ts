...
@Component({
  ...
  template:`
    <section class="page-enter profile-page">
      <div class="page-head"><div><span class="eyebrow">Account</span><h1>Profile & security</h1><p class="muted">Manage your identity, learning timezone, age-safety profile, password and current LearnFlow plan.</p></div></div>
